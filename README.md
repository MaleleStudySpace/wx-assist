...
**关键词提醒 · AI 群摘要 · 公众号速读 · 收藏整理 · AI 对话 · 朋友圈归档 · 聊天导出 · RAG 语义检索 · AI Agent 智能助手**
...
> 另提供 **精简版（no-rag）**——去除了语义检索和 Agent 功能，体积约 **60 MB**，首次启动无需索引，适合不需要语义搜索的用户。  
...
> 源码模式默认包含完整功能。如果不需要 RAG，可以在 `.env` 中关闭 AI Agent 和相关模块。
