...
src/web/server.py 的 _onboarding_data 字典仍有 "proactive_enabled": False / "sticky_mention_enabled": False。不影响功能，但追求极致干净可删。
...
### 1. Git 初始化
```powershell
cd C:\Users\74062\Desktop\wx-assist
git init
git add .
git commit -m "initial: wx-assist 摘星版 — AI 微信消息总结机器人"
```
...
### 3. 清理 onboarding_data 残留
src/web/server.py 中 _onboarding_data 字典的两个已删除功能字段。
