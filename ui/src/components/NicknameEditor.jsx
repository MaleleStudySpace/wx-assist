                    ...
                    <td className="py-2.5">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 bg-bg-raised border border-border-main rounded-lg px-3 py-1.5 text-[14px] text-text-main placeholder:text-text-muted focus:outline-none focus:border-brand-green focus:ring-1 focus:ring-brand-green/15 transition-all"
                        />
